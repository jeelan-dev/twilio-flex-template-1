...
exports.handler = async function (context, event, callback) {
  const {
    ...
    TWILIO_FLEX_RECOVERY_PING_WORKFLOW_SID,
  } = context;
  ...
  await taskService.updateTask(TWILIO_FLEX_WORKSPACE_SID, taskSid, { attributes: JSON.stringify(disconnectedTaskAttributes) });
